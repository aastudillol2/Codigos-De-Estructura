#Ejercicio número 4 de programación: Operación de suma, resta, multiplicación, división y módulo.
#Estudiante: Martín Steed Vélez Segarra
...
#Ejercicio 4
    def operadores (self):
        ...
        self.num2 = int(input("Ingrese un número: "))
...
#Ejercicio 5
    def resolvente (self):
        ...
        self.num1 = int(input("Ingrese un valor de a : "))
        self.num2 = int(input("Ingrese un valor de b : "))
        self.num3 = int(input("Ingrese un valor de c: "))

        d = ((self.num2)**2)-4*self.num1*self.num3
        
        if d > 0: 
            x1 = (-self.num2 + (((self.num2**2) - (4 * self.num1 * self.num3))**0.5)) / (2 * self.num1)
            x2 = (-self.num2 - (((self.num2**2) - (4 * self.num1 * self.num3))** 0.5)) / (2 * self.num1)
            return x1,x2 
        elif d == 0:
            x = -self.num2/(2*self.num1)
            return x
        else: 
            n = "No existe valores"
            return n
...
#Ejercicio 6
    def hipotenusa (self):
        ...
        self.num1 = int(input("Ingrese uno de los catetos: "))
        self.num2 = int(input("Ingrese el segundo cateto: "))

        return ((self.num1 * self.num1)+(self.num2 * self.num2))**0.5
    
#Ejercicio 7     
    def parOimpar (self):

        self.num1 = int(input("Ingrese el segundo cateto: "))
...
#Ejercicio 9  
    def binarioBitparidad (self):
        ...
        self.num4 = int(input("Ingrese un valor en formato binario de 4 dígitos: "))
...
#Ejericio 10 
    def binarioAdecimal (self):
        ...
        self.numbi = int(input("Ingrese un número binario (4 dígitos) para convertirlo a decimales: "))
...
#Ejercicio 11
    def separarUnidades (self)
        ...
        if self.num5 > 1000 and self.num5 < 9999:
            unidadesDemil = self.num5 // 1000
            print ("La unidad de mil es: ", unidadesDemil)
            centenas = (self.num5 - (unidadesDemil * 1000)) // 100
            print ("La centena es:", centenas)
            decenas = (self.num5 - (unidadesDemil * 1000) - (centenas * 100)) // 10
            print ("La decena es: ", decenas)
            unidad = (self.num5 - (unidadesDemil * 1000) - (centenas * 100) - (decenas * 10))
...
#Ejercicio 2 - Parte 2 
    def capicua (self):
        ...
        self.capi = int(input("Ingresar un número de 5 dígitos para conocer si es capicúa: "))

        if 9999 < self.capi < 99999:
            if str(self.capi) == str(self.capi) [::-1]:
                print ("Es capicúa")
            else: 
                print ("No es capicúa")
        else: 
...
#Ejercicio 5 - Parte 2 
    def Mayorque (self):
        ...
        self.C = int(input("Ingresa el tercer número: "))


        if self.A and self.B and self.C > 0:

            if self.C < self.B > self.A:
                print("El primer mayor es: {} ".format(self.B))
                if self.A > self.C: 
                    print("El segundo mayor es: {} ".format(self.A))
                else:
                    print ("El segundo mayor es: {} ".format(self.C))
            elif self.B < self.C > self.A:
                print("El primer mayor es: {} ".format(self.C))
                if self.A > self.B: 
                    print ("El segundo mayor es: {} ".format(self.A))
                else: 
                    print ("El segundo mayor es: {} ".format(self.B))

            elif self.C < self.A > self.B:
                print("El primer mayor es: {} ".format(self.A))
                if self.B > self.C:
                    print ("El segundo mayor es: {} ".format(self.B))
...
#Ejercicio 7 - Parte 2 
    def pesoCorporal (self):
        ...
        self.mpersonal = int(input("Ingrese la masa de la persona: "))

        masa = self.mpersonal/2.205
...
#Ejercicio 5 - Parte 3 
    def clave (self):
        ...
        self.contra = int(input("Ingresa una contraseña conformada por 10 dígitos: "))
...
#Ejercicio 1 - Parte 4
    def calcularMedia (self):
        ...
        promedio = Operaciones.promediarEdad(lista)
        if len(lista) > 0:
...
#Ejercicio 2 - Parte 4
    def elevar (self):
        ...
        elevado = Operaciones.potenciacion(self, base, exponente)
